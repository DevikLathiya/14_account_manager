              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: const [
                      Padding(padding: EdgeInsets.only(left: 5, right: 10), child: Text("Date", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700))),
                      Padding(padding: EdgeInsets.only(left: 5), child: Text("Particular", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700))),
                      Padding(padding: EdgeInsets.only(right: 10), child: Text("Credit", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700))),
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: Text("${_data.trData[index]['date']}", style: TextStyle(color: mycolor, fontSize: 14, fontWeight: FontWeight.w500)),
                              ),
                            ),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Colors.blue.shade100, borderRadius: BorderRadius.horizontal(left: Radius.circular(16))),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: Colors.blue.shade300, borderRadius: BorderRadius.horizontal(right: Radius.circular(16))),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      const Text("Balance", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white)),
                      Text((temp) ? _data.totalBalance.value : "₹ ${widget.person['balance']} ", style: TextStyle(fontSize: 18, color: Colors.white)),
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  TextField(controller: _amount, keyboardType: TextInputType.phone, decoration: const InputDecoration(label: Text("Amount"))),
                  TextField(controller: _particulare, decoration: const InputDecoration(label: Text("Particular"))),
                  SizedBox(height: 4),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
