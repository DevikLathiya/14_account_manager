import 'package:account_manager/Controller%20Screen/database_controller.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void accountDialog(int id, String name, DatabaseController controller) {
    showDialog(
      context: context,
      builder: (context) {
        if (id != 0) {
                    ...
                    onPressed: () {
                      ...
                      if (id == 0) {
                        if (name.isEmpty) {
                          ...
                          //   fontSize: 16.0,
                          // );
                          Get.snackbar('Required', 'Enter Account Name',
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text("Google Drive Sync", style: Theme.of(context).poppinsMedium.copyWith(fontSize: 14)),
                onTap: () => [Get.back(), Get.to(() => SettingsScreen())],
              ),
            ],
          ).paddingAll(20),
        );
...
class CustomSliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget buildFloating(context, DatabaseController controller, double shrinkOffset) {
