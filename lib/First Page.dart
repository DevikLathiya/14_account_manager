...
class _FirstPageState extends State<FirstPage> {
  ...
  List<String> Question1 = ["What was the first mobile that you purchased?",
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Card(margin: const EdgeInsets.symmetric(vertical: 30,horizontal: 10),elevation: 5,
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Container(alignment: Alignment.center,
                          height: 50,width: double.infinity,color: Colors.cyan,
                          child: const Text("Settings",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),),
                        ),
                        Container(height: 50,margin:const EdgeInsets.fromLTRB(5,8,5,5),
                          child: TextField(
                        ...
                        Padding(
                          ...
                          child: DropdownButton(isExpanded: true,underline: Container(),
                        ...
                        Container(margin:const EdgeInsets.all(5),height: 50,
                          child: TextField(
                            controller: _que1,
                    ...
                    Padding(
                      ...
                      child: DropdownButton(isExpanded: true,underline: Container(),
                        ...
                        Container(height: 50,margin: const EdgeInsets.all(5),
                          child: TextField(
                            controller: _que2,
                            decoration: const InputDecoration(labelText: "Answer",border: OutlineInputBorder()),
                          ),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    ElevatedButton(style: ElevatedButton.styleFrom(fixedSize:const Size(80, 30), backgroundColor:Colors.cyan),
                        onPressed: () {
                    ...
                    ElevatedButton(style: ElevatedButton.styleFrom(fixedSize:const Size(80, 30), backgroundColor:Colors.cyan),
                      ...
                      if(_pass.text.isEmpty)
                        ...
                        Question1 = _selected1!;  Question2 = _selected2!;
                        answer1 = _que1.text; answer2 = _que2.text;
