...
//
//     PasswordScreen.database = await openDatabase(
//       path,
//       version: 3,
...
//     data.selectData();
//
//     final tables = await PasswordScreen.database!.query('sqlite_master', where: 'type = ? AND name = ?', whereArgs: ['table', 'Account']);
//     (tables.isNotEmpty) ? print('Table exists!') : print('Table does not exist!');
//
//     final table = await PasswordScreen.database!.query('sqlite_master', where: 'type = ? AND name = ?', whereArgs: ['table', 'MyTransaction']);
...
//   MyController data = Get.put(MyController());
//
//   DigitHolder({required this.selectedIndex, Key? key, required this.width, required this.index, required this.code}) : super(key: key);
//
//   final double width;
//
//   @override
