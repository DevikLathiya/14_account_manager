...
class _PasswordScreenState extends State<PasswordScreen> {
  ...
  dataTable() async {
        ...
        PasswordScreen.database = await openDatabase(path, version: 3,
    ...
    final tables = await PasswordScreen.database!.query(
      'sqlite_master',
      where: 'type = ? AND name = ?', whereArgs: ['table', 'Account'],
    );
    (tables.isNotEmpty) ? print('Table exists!') : print('Table does not exist!');

    final table = await PasswordScreen.database!.query(
      'sqlite_master',
      where: 'type = ? AND name = ?', whereArgs: ['table', 'MyTransaction'],
    );
          ...
          child: Column(
            children: [
              Container(height: height * 0.15, width: width,
                color: Colors.black.withBlue(40), alignment: Alignment.center,
                child: SizedBox(
                    height: height * 0.06, width: height * 0.06,
                    child: const Icon(Icons.book,color: Colors.white,size: 70,)),
              ),
              Container(
                  height: height * 0.80, width: width,
                          ...
                          children: [
                            ...
                            InkWell(onTap: () {
                             showDialog(context: context, builder: (context) {
                               return  AlertDialog(
                                 title: Container(width: double.infinity,height: 50,color: Colors.cyan,alignment: Alignment.center,
                                   child: const Text("Forgot Password?"),),
                                 content:  SizedBox(height: 300,width: double.infinity,
                                   child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                     children: [
                                       Text("➽ Give following  Security questions answer for reset password.",
                                         style: TextStyle(fontSize: 12,color: Colors.grey.shade400),textAlign: TextAlign.center,),
                                       const SizedBox(height: 10),
                                       Text("➽ ${box.get("Question1")}"),
                                       TextField(controller: _answer1,
                                         decoration: const InputDecoration(hintText: "Answer")),
                                       const SizedBox(height: 10,),
                                       Text("➽ ${box.get("Question2")}"),
                                       TextField(controller: _answer2,
                                           decoration: const InputDecoration(hintText: "Answer")),
                                       const SizedBox(height: 10),
                                       Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                         children: [
                                           GFButton(
                                             ...
                                             type: GFButtonType.outline, shape: GFButtonShape.pills, color: Colors.cyan,
                                           ),
                                           GFButton(
                                             onPressed: () {
                                               if(_answer1.text.isEmpty || _answer2.text.isEmpty)
                                               {
                                                 Fluttertoast.showToast(
                                                     ...
                                                     timeInSecForIosWeb: 1, backgroundColor: Colors.cyan,
                                                 ...
                                                 showDialog(context: context, builder: (context) {
                                                   return  AlertDialog(
                                                     ...
                                                     content:  SizedBox(height: 120,width: double.infinity,
                                                       child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                                         children: [
                                                           TextField(controller: _newPass,keyboardType: TextInputType.phone,
                                                           ...
                                                           Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                                             children: [
                                                               ...
                                                               GFButton(
                                                                 ...
                                                                 shape: GFButtonShape.pills, color: Colors.cyan,
                                                               ),
                                                             ],
                                                           )
                                                         ],
                      ...
                      Expanded(flex: 2,
                        child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                DigitHolder(width: width,
                                  index: 0,
                                  selectedIndex: selectedIndex, code: code,),
                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(30, 10, 10, 10),alignment:Alignment.center,height: 50,width: 50,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                      ...
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(20,10,20,10),alignment:Alignment.center,height: 50,width: 50,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                      ...
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(10, 10, 30, 10),alignment:Alignment.center,height: 50,width: 50,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(30, 20, 10, 20),
                                              alignment:Alignment.center, height: 50,width: 40,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                      ...
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(10, 20, 30, 20),
                                              alignment:Alignment.center,height: 50,width: 40,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(30, 20, 10, 20),alignment:Alignment.center,height: 60,width: 50,
                                              decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(5),
                                              boxShadow: [
                                                BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                                BoxShadow(color: Colors.grey.shade300,offset:const Offset(-1, -2),blurRadius: 15,)]),
                                      ...
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin:const EdgeInsets.all(20),alignment:Alignment.center,height: 60,width: 50,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [
                                                    BoxShadow(color: Colors.grey.shade300,offset:const Offset(1, 6),blurRadius: 10,),
                                                    BoxShadow(color: Colors.grey.shade300,offset:const Offset(-1, -2),blurRadius: 15,)] ),
                                      ...
                                      Expanded(
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(margin: const EdgeInsets.fromLTRB(10, 20, 30, 20),alignment:Alignment.center,height: 60,width: 50,
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: const Offset(1, 6),blurRadius: 10,),
                                              BoxShadow(color: Colors.grey.shade300,offset: const Offset(-1, -2),blurRadius: 15,)]),
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(
                                              margin: const EdgeInsets.fromLTRB(30, 20, 10, 20),alignment:Alignment.center,height: 60,width: 50,
                                              decoration: BoxDecoration(color: Colors.red.shade400,borderRadius: BorderRadius.circular(5),),
                                              child: Icon(Icons.backspace_outlined, color: Colors.black.withBlue(40), size: 30)),
                                        ),
                                      ),
                                      Expanded(flex: 1,
                                        child: InkWell(onTap: () {
                                          ...
                                          child: Container(
                                              ...
                                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(5),
                                                  boxShadow: [BoxShadow(color: Colors.grey.shade300,offset: Offset(1, 6),blurRadius: 10,),
                                      ...
                                      Expanded(flex: 1,
                                        child: InkWell(
                                          ...
                                          child: Container(
                                              margin: const EdgeInsets.fromLTRB(10, 20, 30, 20),alignment:Alignment.center,height: 60,width: 50,
                                              decoration: BoxDecoration(color: Colors.green.shade400,borderRadius: BorderRadius.circular(5)),
                                              child: Icon(Icons.check, color: Colors.black.withBlue(40), size: 30)),
                                        ),
                                      ),
                                    ],
                                  )),
...
class DigitHolder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(alignment: Alignment.center,
        height: width * 0.17, width: width * 0.17,
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: data.index == data.selectedindex ? Colors.cyan : Colors.transparent,
                offset:const Offset(0, 0), spreadRadius: 1.5, blurRadius: 2,
              )
            ]),
